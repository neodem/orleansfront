...
public class PathBetween_______________________ {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PathBetween_______________________) == false) {
            return false;
        }
        PathBetween_______________________ rhs = ((PathBetween_______________________) other);
