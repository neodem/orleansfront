...
public class LeBlancChateauroux {

    @JsonProperty("pathBetween")
    private PathBetween_________________________________ pathBetween;
    ...
    @JsonProperty("pathBetween")
    public PathBetween_________________________________ getPathBetween() {
        return pathBetween;
    }

    @JsonProperty("pathBetween")
    public void setPathBetween(PathBetween_________________________________ pathBetween) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LeBlancChateauroux) == false) {
            return false;
        }
        LeBlancChateauroux rhs = ((LeBlancChateauroux) other);
