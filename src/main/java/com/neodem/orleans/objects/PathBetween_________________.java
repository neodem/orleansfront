...
public class PathBetween_________________ {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PathBetween_________________) == false) {
            return false;
        }
        PathBetween_________________ rhs = ((PathBetween_________________) other);
