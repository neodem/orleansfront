...
public class OrleansBriare {

    @JsonProperty("pathBetween")
    private PathBetween________________________________ pathBetween;
    ...
    @JsonProperty("pathBetween")
    public PathBetween________________________________ getPathBetween() {
        return pathBetween;
    }

    @JsonProperty("pathBetween")
    public void setPathBetween(PathBetween________________________________ pathBetween) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OrleansBriare) == false) {
            return false;
        }
        OrleansBriare rhs = ((OrleansBriare) other);
