...
public class PathBetween_____________________________________________________ {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PathBetween_____________________________________________________) == false) {
            return false;
        }
        PathBetween_____________________________________________________ rhs = ((PathBetween_____________________________________________________) other);
