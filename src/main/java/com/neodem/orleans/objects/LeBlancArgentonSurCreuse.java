...
public class LeBlancArgentonSurCreuse {

    @JsonProperty("pathBetween")
    private PathBetween_________________________ pathBetween;
    ...
    @JsonProperty("pathBetween")
    public PathBetween_________________________ getPathBetween() {
        return pathBetween;
    }

    @JsonProperty("pathBetween")
    public void setPathBetween(PathBetween_________________________ pathBetween) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LeBlancArgentonSurCreuse) == false) {
            return false;
        }
        LeBlancArgentonSurCreuse rhs = ((LeBlancArgentonSurCreuse) other);
