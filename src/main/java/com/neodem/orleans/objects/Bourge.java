...
public class Bourge {
    ...
    private PathBetween______________ pathBetween;
    ...
    @JsonProperty("pathBetween")
    public PathBetween______________ getPathBetween() {
        return pathBetween;
    }

    @JsonProperty("pathBetween")
    public void setPathBetween(PathBetween______________ pathBetween) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Bourge) == false) {
            return false;
        }
        Bourge rhs = ((Bourge) other);
