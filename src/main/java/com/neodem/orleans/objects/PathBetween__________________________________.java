...
public class PathBetween__________________________________ {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PathBetween__________________________________) == false) {
            return false;
        }
        PathBetween__________________________________ rhs = ((PathBetween__________________________________) other);
