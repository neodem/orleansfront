...
public class Chinon {
    ...
    private PathBetween________ pathBetween;
    ...
    @JsonProperty("pathBetween")
    public PathBetween________ getPathBetween() {
        return pathBetween;
    }

    @JsonProperty("pathBetween")
    public void setPathBetween(PathBetween________ pathBetween) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Chinon) == false) {
            return false;
        }
        Chinon rhs = ((Chinon) other);
