...
public class PathBetween____________________ {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PathBetween____________________) == false) {
            return false;
        }
        PathBetween____________________ rhs = ((PathBetween____________________) other);
