...
public class Venedome {

    @JsonProperty("pathBetween")
    private PathBetween_________ pathBetween;
    ...
    @JsonProperty("pathBetween")
    public PathBetween_________ getPathBetween() {
        return pathBetween;
    }

    @JsonProperty("pathBetween")
    public void setPathBetween(PathBetween_________ pathBetween) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Venedome) == false) {
            return false;
        }
        Venedome rhs = ((Venedome) other);
