...
public class LeMansChateaudun {

    @JsonProperty("pathBetween")
    private PathBetween________________________ pathBetween;
    ...
    @JsonProperty("pathBetween")
    public PathBetween________________________ getPathBetween() {
        return pathBetween;
    }

    @JsonProperty("pathBetween")
    public void setPathBetween(PathBetween________________________ pathBetween) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LeMansChateaudun) == false) {
            return false;
        }
        LeMansChateaudun rhs = ((LeMansChateaudun) other);
