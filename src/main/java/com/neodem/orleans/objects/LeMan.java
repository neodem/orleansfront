...
public class LeMan {
    ...
    private PathBetween_____ pathBetween;
    ...
    @JsonProperty("pathBetween")
    public PathBetween_____ getPathBetween() {
        return pathBetween;
    }

    @JsonProperty("pathBetween")
    public void setPathBetween(PathBetween_____ pathBetween) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LeMan) == false) {
            return false;
        }
        LeMan rhs = ((LeMan) other);
