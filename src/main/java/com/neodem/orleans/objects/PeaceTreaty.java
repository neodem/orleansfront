...
public class PeaceTreaty {
    ...
    @JsonProperty("track")
    private List<Track______> track = null;
    ...
    @JsonProperty("track")
    public List<Track______> getTrack() {
        return track;
    }

    @JsonProperty("track")
    public void setTrack(List<Track______> track) {
        this.track = track;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PeaceTreaty) == false) {
            return false;
        }
        PeaceTreaty rhs = ((PeaceTreaty) other);
