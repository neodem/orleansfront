...
public class PathBetween_____________________________ {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PathBetween_____________________________) == false) {
            return false;
        }
        PathBetween_____________________________ rhs = ((PathBetween_____________________________) other);
