...
public class VierzonChateauroux {

    @JsonProperty("pathBetween")
    private PathBetween_____________________________ pathBetween;
    ...
    @JsonProperty("pathBetween")
    public PathBetween_____________________________ getPathBetween() {
        return pathBetween;
    }

    @JsonProperty("pathBetween")
    public void setPathBetween(PathBetween_____________________________ pathBetween) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof VierzonChateauroux) == false) {
            return false;
        }
        VierzonChateauroux rhs = ((VierzonChateauroux) other);
