...
public class Bloi {
    ...
    private PathBetween__ pathBetween;
    ...
    @JsonProperty("pathBetween")
    public PathBetween__ getPathBetween() {
        return pathBetween;
    }

    @JsonProperty("pathBetween")
    public void setPathBetween(PathBetween__ pathBetween) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Bloi) == false) {
            return false;
        }
        Bloi rhs = ((Bloi) other);
