...
public class MontrichardLoch {

    @JsonProperty("pathBetween")
    private PathBetween____________________________ pathBetween;
    ...
    @JsonProperty("pathBetween")
    public PathBetween____________________________ getPathBetween() {
        return pathBetween;
    }

    @JsonProperty("pathBetween")
    public void setPathBetween(PathBetween____________________________ pathBetween) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MontrichardLoch) == false) {
            return false;
        }
        MontrichardLoch rhs = ((MontrichardLoch) other);
