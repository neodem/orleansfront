...
public class Loch {
    ...
    private PathBetween____________ pathBetween;
    ...
    @JsonProperty("pathBetween")
    public PathBetween____________ getPathBetween() {
        return pathBetween;
    }

    @JsonProperty("pathBetween")
    public void setPathBetween(PathBetween____________ pathBetween) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Loch) == false) {
            return false;
        }
        Loch rhs = ((Loch) other);
