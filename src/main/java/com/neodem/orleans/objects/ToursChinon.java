...
public class ToursChinon {

    @JsonProperty("pathBetween")
    private PathBetween______________________________________ pathBetween;
    ...
    @JsonProperty("pathBetween")
    public PathBetween______________________________________ getPathBetween() {
        return pathBetween;
    }

    @JsonProperty("pathBetween")
    public void setPathBetween(PathBetween______________________________________ pathBetween) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ToursChinon) == false) {
            return false;
        }
        ToursChinon rhs = ((ToursChinon) other);
