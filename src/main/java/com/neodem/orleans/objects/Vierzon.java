...
public class Vierzon {

    @JsonProperty("pathBetween")
    private PathBetween_______ pathBetween;
    ...
    @JsonProperty("pathBetween")
    public PathBetween_______ getPathBetween() {
        return pathBetween;
    }

    @JsonProperty("pathBetween")
    public void setPathBetween(PathBetween_______ pathBetween) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Vierzon) == false) {
            return false;
        }
        Vierzon rhs = ((Vierzon) other);
