...
public class ChatellerautArgentonSurCreuse {

    @JsonProperty("pathBetween")
    private PathBetween______________________________ pathBetween;
    ...
    @JsonProperty("pathBetween")
    public PathBetween______________________________ getPathBetween() {
        return pathBetween;
    }

    @JsonProperty("pathBetween")
    public void setPathBetween(PathBetween______________________________ pathBetween) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ChatellerautArgentonSurCreuse) == false) {
            return false;
        }
        ChatellerautArgentonSurCreuse rhs = ((ChatellerautArgentonSurCreuse) other);
