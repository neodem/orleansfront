...
public class PathBetween______________________________________________________ {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PathBetween______________________________________________________) == false) {
            return false;
        }
        PathBetween______________________________________________________ rhs = ((PathBetween______________________________________________________) other);
