...
public class SancerreNever {

    @JsonProperty("pathBetween")
    private PathBetween_______________________________________ pathBetween;
    ...
    @JsonProperty("pathBetween")
    public PathBetween_______________________________________ getPathBetween() {
        return pathBetween;
    }

    @JsonProperty("pathBetween")
    public void setPathBetween(PathBetween_______________________________________ pathBetween) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SancerreNever) == false) {
            return false;
        }
        SancerreNever rhs = ((SancerreNever) other);
