...
public class PathBetween______________ {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PathBetween______________) == false) {
            return false;
        }
        PathBetween______________ rhs = ((PathBetween______________) other);
