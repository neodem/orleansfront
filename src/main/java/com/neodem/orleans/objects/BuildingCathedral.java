...
public class BuildingCathedral {

    @JsonProperty("track")
    private List<Track________> track = null;
    ...
    @JsonProperty("track")
    public List<Track________> getTrack() {
        return track;
    }

    @JsonProperty("track")
    public void setTrack(List<Track________> track) {
        this.track = track;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BuildingCathedral) == false) {
            return false;
        }
        BuildingCathedral rhs = ((BuildingCathedral) other);
