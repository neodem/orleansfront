...
public class FoundingBoatmenGuild {

    @JsonProperty("track")
    private List<Track_______> track = null;
    ...
    @JsonProperty("track")
    public List<Track_______> getTrack() {
        return track;
    }

    @JsonProperty("track")
    public void setTrack(List<Track_______> track) {
        this.track = track;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FoundingBoatmenGuild) == false) {
            return false;
        }
        FoundingBoatmenGuild rhs = ((FoundingBoatmenGuild) other);
