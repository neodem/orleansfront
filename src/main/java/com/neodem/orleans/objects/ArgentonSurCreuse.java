...
public class ArgentonSurCreuse {

    @JsonProperty("pathBetween")
    private PathBetween________________ pathBetween;
    ...
    @JsonProperty("pathBetween")
    public PathBetween________________ getPathBetween() {
        return pathBetween;
    }

    @JsonProperty("pathBetween")
    public void setPathBetween(PathBetween________________ pathBetween) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ArgentonSurCreuse) == false) {
            return false;
        }
        ArgentonSurCreuse rhs = ((ArgentonSurCreuse) other);
