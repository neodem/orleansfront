...
public class PapalConclave {
    ...
    @JsonProperty("track")
    private List<Track___> track = null;
    ...
    @JsonProperty("track")
    public List<Track___> getTrack() {
        return track;
    }

    @JsonProperty("track")
    public void setTrack(List<Track___> track) {
        this.track = track;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PapalConclave) == false) {
            return false;
        }
        PapalConclave rhs = ((PapalConclave) other);
