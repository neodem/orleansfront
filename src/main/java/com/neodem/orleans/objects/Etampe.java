...
public class Etampe {
    ...
    private PathBetween__________ pathBetween;
    ...
    @JsonProperty("pathBetween")
    public PathBetween__________ getPathBetween() {
        return pathBetween;
    }

    @JsonProperty("pathBetween")
    public void setPathBetween(PathBetween__________ pathBetween) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Etampe) == false) {
            return false;
        }
        Etampe rhs = ((Etampe) other);
