...
public class LaChatre {

    @JsonProperty("pathBetween")
    private PathBetween___ pathBetween;
    ...
    @JsonProperty("pathBetween")
    public PathBetween___ getPathBetween() {
        return pathBetween;
    }

    @JsonProperty("pathBetween")
    public void setPathBetween(PathBetween___ pathBetween) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LaChatre) == false) {
            return false;
        }
        LaChatre rhs = ((LaChatre) other);
