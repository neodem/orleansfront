...
public class PathBetween________________________ {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PathBetween________________________) == false) {
            return false;
        }
        PathBetween________________________ rhs = ((PathBetween________________________) other);
