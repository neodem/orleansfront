...
public class VenedomeBloi {

    @JsonProperty("pathBetween")
    private PathBetween___________________________ pathBetween;
    ...
    @JsonProperty("pathBetween")
    public PathBetween___________________________ getPathBetween() {
        return pathBetween;
    }

    @JsonProperty("pathBetween")
    public void setPathBetween(PathBetween___________________________ pathBetween) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof VenedomeBloi) == false) {
            return false;
        }
        VenedomeBloi rhs = ((VenedomeBloi) other);
