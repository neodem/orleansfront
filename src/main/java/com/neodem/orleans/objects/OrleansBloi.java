...
public class OrleansBloi {

    @JsonProperty("pathBetween")
    private PathBetween_________________________________________________ pathBetween;
    ...
    @JsonProperty("pathBetween")
    public PathBetween_________________________________________________ getPathBetween() {
        return pathBetween;
    }

    @JsonProperty("pathBetween")
    public void setPathBetween(PathBetween_________________________________________________ pathBetween) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OrleansBloi) == false) {
            return false;
        }
        OrleansBloi rhs = ((OrleansBloi) other);
