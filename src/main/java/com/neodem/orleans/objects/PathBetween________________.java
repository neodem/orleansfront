...
public class PathBetween________________ {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PathBetween________________) == false) {
            return false;
        }
        PathBetween________________ rhs = ((PathBetween________________) other);
