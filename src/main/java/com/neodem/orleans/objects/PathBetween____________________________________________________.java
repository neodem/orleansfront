...
public class PathBetween____________________________________________________ {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PathBetween____________________________________________________) == false) {
            return false;
        }
        PathBetween____________________________________________________ rhs = ((PathBetween____________________________________________________) other);
