...
public class PathBetween_______________ {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PathBetween_______________) == false) {
            return false;
        }
        PathBetween_______________ rhs = ((PathBetween_______________) other);
