...
public class PathBetween___________________ {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PathBetween___________________) == false) {
            return false;
        }
        PathBetween___________________ rhs = ((PathBetween___________________) other);
