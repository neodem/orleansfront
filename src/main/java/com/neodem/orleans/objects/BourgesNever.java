...
public class BourgesNever {

    @JsonProperty("pathBetween")
    private PathBetween_______________________________ pathBetween;
    ...
    @JsonProperty("pathBetween")
    public PathBetween_______________________________ getPathBetween() {
        return pathBetween;
    }

    @JsonProperty("pathBetween")
    public void setPathBetween(PathBetween_______________________________ pathBetween) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BourgesNever) == false) {
            return false;
        }
        BourgesNever rhs = ((BourgesNever) other);
