...
public class Sancerre {

    @JsonProperty("pathBetween")
    private PathBetween______ pathBetween;
    ...
    @JsonProperty("pathBetween")
    public PathBetween______ getPathBetween() {
        return pathBetween;
    }

    @JsonProperty("pathBetween")
    public void setPathBetween(PathBetween______ pathBetween) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sancerre) == false) {
            return false;
        }
        Sancerre rhs = ((Sancerre) other);
