...
public class DefeatingPlague {

    @JsonProperty("track")
    private List<Track____> track = null;
    ...
    @JsonProperty("track")
    public List<Track____> getTrack() {
        return track;
    }

    @JsonProperty("track")
    public void setTrack(List<Track____> track) {
        this.track = track;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DefeatingPlague) == false) {
            return false;
        }
        DefeatingPlague rhs = ((DefeatingPlague) other);
