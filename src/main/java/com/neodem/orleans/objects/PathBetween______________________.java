...
public class PathBetween______________________ {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PathBetween______________________) == false) {
            return false;
        }
        PathBetween______________________ rhs = ((PathBetween______________________) other);
