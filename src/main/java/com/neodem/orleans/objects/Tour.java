...
public class Tour {
    ...
    private PathBetween____ pathBetween;
    ...
    @JsonProperty("pathBetween")
    public PathBetween____ getPathBetween() {
        return pathBetween;
    }

    @JsonProperty("pathBetween")
    public void setPathBetween(PathBetween____ pathBetween) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Tour) == false) {
            return false;
        }
        Tour rhs = ((Tour) other);
