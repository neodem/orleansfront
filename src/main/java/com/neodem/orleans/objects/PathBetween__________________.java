...
public class PathBetween__________________ {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PathBetween__________________) == false) {
            return false;
        }
        PathBetween__________________ rhs = ((PathBetween__________________) other);
