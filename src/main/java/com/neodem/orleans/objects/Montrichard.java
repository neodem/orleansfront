...
public class Montrichard {

    @JsonProperty("pathBetween")
    private PathBetween______________________ pathBetween;
    ...
    @JsonProperty("pathBetween")
    public PathBetween______________________ getPathBetween() {
        return pathBetween;
    }

    @JsonProperty("pathBetween")
    public void setPathBetween(PathBetween______________________ pathBetween) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Montrichard) == false) {
            return false;
        }
        Montrichard rhs = ((Montrichard) other);
