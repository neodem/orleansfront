...
public class ToursLoch {

    @JsonProperty("pathBetween")
    private PathBetween__________________________ pathBetween;
    ...
    @JsonProperty("pathBetween")
    public PathBetween__________________________ getPathBetween() {
        return pathBetween;
    }

    @JsonProperty("pathBetween")
    public void setPathBetween(PathBetween__________________________ pathBetween) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ToursLoch) == false) {
            return false;
        }
        ToursLoch rhs = ((ToursLoch) other);
