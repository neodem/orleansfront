...
public class Chateauroux {

    @JsonProperty("pathBetween")
    private PathBetween____________________ pathBetween;
    ...
    @JsonProperty("pathBetween")
    public PathBetween____________________ getPathBetween() {
        return pathBetween;
    }

    @JsonProperty("pathBetween")
    public void setPathBetween(PathBetween____________________ pathBetween) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Chateauroux) == false) {
            return false;
        }
        Chateauroux rhs = ((Chateauroux) other);
