...
public class PathBetween_____________________ {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PathBetween_____________________) == false) {
            return false;
        }
        PathBetween_____________________ rhs = ((PathBetween_____________________) other);
