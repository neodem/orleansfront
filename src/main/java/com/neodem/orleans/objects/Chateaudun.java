...
public class Chateaudun {

    @JsonProperty("pathBetween")
    private PathBetween_ pathBetween;
    ...
    @JsonProperty("pathBetween")
    public PathBetween_ getPathBetween() {
        return pathBetween;
    }

    @JsonProperty("pathBetween")
    public void setPathBetween(PathBetween_ pathBetween) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Chateaudun) == false) {
            return false;
        }
        Chateaudun rhs = ((Chateaudun) other);
